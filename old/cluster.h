...
void intDumper2(int nr, int nc, double** data, int** mask);
void intDumper3(int nr, int nc, int** mask, double** data);
void intDumper(int nr, int nc, int** mask);
int** makemask(int nr, int nc);
...
Node* treecluster (int nrows, int ncolumns, double** data,  double weight[], 
		   int transpose, char dist, char method, double** distmatrix);
